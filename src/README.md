# Non-dimensional age equation
Ice sheet age equation in the physical (x,z) is commonly written as

$$ \frac{\partial X}{\partial t} + u \frac{\partial X}{\partial x} + w \frac{\partial X}{\partial z} = 1 $$

To non-dimensionalize the equation, we adopt the $\sigma$ (terrain-following) coordinate system. Let the surface topography and bed topography be denoted as $s(x,z)$ and $b(x,z)$ respectively, we can write using $\zeta \in [0,1]$ that
$$
